...
if (isset($_GET['delid'])) {
  ...
  writeLog("Notice #" . $rid . " - Deleted by Admin #" . $uid . ".");
              ...
              <div class="card-body">
                    ...
                    if ($query->rowCount() > 0) {
                      foreach ($results as $row) {
                        ...
                        <tr>
                          ...
                          <td>
                            <div>
                              <a href="edit-notice-detail.php?editid=<?php echo htmlentities($row->nid); ?>"><i
                                    class="icon-eye"></i></a>
                ...
                <div align="left">
                  <ul class="pagination">
                    ...
                    <li><a href="?pageno=<?php echo htmlentities($total_pages); ?>"><strong
