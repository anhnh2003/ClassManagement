                    ...
                    <div class="form-group">
                      ...
                      <label for="exampleInputName1">Creation Time</label>
                        <input type="text" name="ctime"
                             value="<?php echo htmlentities($row->CreationTime); ?>"
                             class="form-control" required='true' readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">QR Valid Time <i>(seconds)</i></label>
                        <input type="text" name="ttl"
                             value="<?php echo htmlentities($row->TimeToLive); ?>"
                             class="form-control" required='true' pattern="[0-9]+">
                      </div>
                      <?php $cnt = $cnt + 1;
                    }
                  } ?>
                  <button type="submit" class="btn btn-primary mr-2" name="update_ttl">Update
                  </button>
                  <button type="submit" class="btn btn-primary mr-2" name="genqr">Generate QR
                  </button>
                </form>
                <?php
