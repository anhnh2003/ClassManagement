...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tblstudent WHERE Email=:email and ContactNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblstudent set Password=:newpassword where Email=:email and ContactNumber=:mobile";
